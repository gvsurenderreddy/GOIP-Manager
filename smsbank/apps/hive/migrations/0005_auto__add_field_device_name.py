...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'hive_device', 'name',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'hive_device', 'name')
    ...
    models = {
        ...
        u'hive.device': {
            ...
            'device_id': ('django.db.models.fields.CharField', [], {'max_length': '100', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
